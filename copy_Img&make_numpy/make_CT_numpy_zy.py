...
def load_data1(newsize=[299*2,299*2],tvt=5):
    print('start...')
    ImageLaterality='R' 
    ypathlist=['/home/tuixiangbeijingtest0/workspace/xls/CT_50_cancer.xls'
    ,'/home/tuixiangbeijingtest0/workspace/xls/CT_50_health.xls']
    ...
    for folderi in randomlist:
        ...
        if len(folder)==0:
            ...
            newpath='/media/disk_sda/srv/CT_50_0901'+foldercol1[folderi]+foldercol[folderi]+'hh'
            #print(newpath)
    ...
    np.save('/home/tuixiangbeijingtest0/Desktop/workfolder/numpy/ct_sdy/ct220_random_X_train.npy',X_train) #change save path
