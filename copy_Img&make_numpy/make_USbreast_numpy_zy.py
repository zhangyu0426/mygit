...
#    X_test=X_test[:,0:48,...]
    ...
    for content in [list_LASTSAVETIME_val, list_PATIENT_ID, list_DESCRIPTION, list_IMPRESSION, list_filename, list_tag]:
        ...
        for item in content:      
            ...
            xlcount+=1   
        colcount += 1
    np_risno.save('/home/tuixiangbeijingtest0/workspace/xls/US_Breast_validation_patientID'+str(ration)+'_'+str(newsize[0])+'.xls') 

    np.save('/media/disk_sdb/numpy/US_zy/Breast'+str(ration)+'_'+str(newsize[0])+'random_X_train.npy',X_train)
    np.save('/media/disk_sdb/numpy/US_zy/Breast'+str(ration)+'_'+str(newsize[0])+'random_Y_train.npy',Y_train)
    np.save('/media/disk_sdb/numpy/US_zy/Breast'+str(ration)+'_'+str(newsize[0])+'random_X_val.npy',X_val)
    np.save('/media/disk_sdb/numpy/US_zy/Breast'+str(ration)+'_'+str(newsize[0])+'random_Y_val.npy',Y_val)      
    np.save('/media/disk_sdb/numpy/US_zy/Breast'+str(ration)+'_'+str(newsize[0])+'random_X_test.npy',X_test)
    np.save('/media/disk_sdb/numpy/US_zy/Breast'+str(ration)+'_'+str(newsize[0])+'random_Y_test.npy',Y_test)            
    time_end = time.time()
