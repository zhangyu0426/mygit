...
def load_data1(newsize=[299,299],tvt=5):
    ...
    for folderi in randomlist:
        ...
        if count441_p + count441_n >= ris_num :
            break
                ...
                if 1==1:
                    ...
                    if rawtext==0 :#and count0 < 9000:
                        ...
                        if riscol[folderi] in vallist:
                            if dict_ris_pics[riscol[folderi]] < pics_of_one - 1:
                                Y_val.append(0)
                                X_val.append(pix)
                                dict_ris_pics[riscol[folderi]] += 1
                                count0 += 1
                                print(count0)
                                if dict_ris_pics[riscol[folderi]] >= pics_of_one - 1:
                                    count441_p += 1
    ...
    np.save('/home/tuixiangbeijingtest0/Desktop/workfolder/numpy/ct_sdy/ct220_48_random_X_train.npy',X_train)
    np.save('/home/tuixiangbeijingtest0/Desktop/workfolder/numpy/ct_sdy/ct220_48_random_Y_train.npy',Y_train)
    np.save('/home/tuixiangbeijingtest0/Desktop/workfolder/numpy/ct_sdy/ct220_48_random_X_val.npy',X_val)
    np.save('/home/tuixiangbeijingtest0/Desktop/workfolder/numpy/ct_sdy/ct220_48_random_Y_val.npy',Y_val)      
    np.save('/home/tuixiangbeijingtest0/Desktop/workfolder/numpy/ct_sdy/ct220_48_random_X_test.npy',X_test)
    np.save('/home/tuixiangbeijingtest0/Desktop/workfolder/numpy/ct_sdy/ct220_48_random_Y_test.npy',Y_test)            
