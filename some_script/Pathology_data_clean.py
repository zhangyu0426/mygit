...
excelname = ['RuXian_health.xls','RuXian_cancer.xls']  #health and sick excel write here
savepath  = '/media/tx-eva/0f75bc71-c713-4ff8-a186-764bd526b22f/pathology_ruxian_cancer/'
val_excel = 'pathology_ruxian_cancer'
numpypath = '/media/tx-eva/0f75bc71-c713-4ff8-a186-764bd526b22f/numpy/pathology_ruxian_cancer/'
numpyname = 'pathology_ruxian_cancer'
...
def data_clean(newsize=[299,299],tvt=5,excelpath=excelpath,excelname=excelname):
    ...
    for ypath in ypathlist: #ypathlist is datasource
        ...
        IMPRESSIONcol+=sh.col_values(7)[1:]
        UNC_PATHcol+=sh.col_values(10)[1:]
        FILENAMEcol+=sh.col_values(11)[1:]
        FLAGcol+=sh.col_values(12)[1:]
    ...
    for folderi in randomlist:
        ...
        if len(folder)==0:
            ...
            if FLAGcol[folderi] == 0:
                cmdcp = 'cp  '+cmdstr1+' '+savepath+'0'
            if FLAGcol[folderi] == 1:
                cmdcp = 'cp  '+cmdstr1+' '+savepath+'1'
            os.system(cmdcp)   
                ...
                if 1==1:              
                    ...
                    if FLAGcol[folderi]==0:
                        ...
                        if indexremain0==0:
                            ...
                            X_train.append(pix)
                        count0+=1
                        print('Ruxian_cancer:'+str(count0)+'/'+str(len(PATIENT_LOCAL_IDcol)))
                        ...
                        if indexremain1==0:
                            ...
                            X_train.append(pix)
                        count1+=1
                        print('Ruxian_health:'+str(count1)+'/'+str(len(PATIENT_LOCAL_IDcol)))
