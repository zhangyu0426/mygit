...
def load_data1(newsize=[299,299],tvt=5):
    print('start...')
    ImageLaterality='R' 
    ...
    for ris in range(0,len(rislist)):
        if len(str(rislist[ris])) < 8 :
            continue
        #print('number:',rislist[ris])
        #print('ris:',ris)
        #print('riscol:',riscol[1])
        #pass
        count0 = 0
        count1 = 0
        for folderi in randomlist:
            #print('number:',folderi)
            #print(folderi)
            #if(and count1==2000 and count0==2000):
                #break;
            folder=foldercol[folderi]
            
            if count0 >= 48 and count1 >= 48 :
                break
            if rislist[ris] <> riscol[folderi] :
                continue
            if len(folder)==0:
                pass
            else:
    ...
    np.save('/home/tuixiangbeijingtest0/Desktop/workfolder/numpy/ct_zy/ct220_random_X_train.npy',X_train)
    np.save('/home/tuixiangbeijingtest0/Desktop/workfolder/numpy/ct_zy/ct220_random_Y_train.npy',Y_train)
    np.save('/home/tuixiangbeijingtest0/Desktop/workfolder/numpy/ct_zy/ct220_random_X_val.npy',X_val)
    np.save('/home/tuixiangbeijingtest0/Desktop/workfolder/numpy/ct_zy/ct220_random_Y_val.npy',Y_val)      
    np.save('/home/tuixiangbeijingtest0/Desktop/workfolder/numpy/ct_zy/ct220_random_X_test.npy',X_test)
    np.save('/home/tuixiangbeijingtest0/Desktop/workfolder/numpy/ct_zy/ct220_random_Y_test.npy',Y_test)            
    return X_train, Y_train, X_val, Y_val, X_test, Y_test

load_data1(newsize=[299,299],tvt=5)
