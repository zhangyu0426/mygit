...
modelsavedir = '/media/tx-eva/0f75bc71-c713-4ff8-a186-764bd526b22f/params_1w-7k/2/'
modelloaddir = '/home/tx-eva/workspace/zcw/model/'
dataloaddir = '/media/tx-eva/0f75bc71-c713-4ff8-a186-764bd526b22f/numpy/ZengZhiZao_zy/ZengZhiZao_zy/'

print("Loading data...")
X_train=np.load(dataloaddir + 'CR_1w_3kzzz+7k_15804_224_X_train.npy')
Y_train=np.load(dataloaddir + 'CR_1w_3kzzz+7k_15804_224_Y_train.npy')
X_val=np.load(dataloaddir + 'CR_1w_3kzzz+7k_5268_224_X_val.npy')
Y_val=np.load(dataloaddir + 'CR_1w_3kzzz+7k_5268_224_Y_val.npy')
